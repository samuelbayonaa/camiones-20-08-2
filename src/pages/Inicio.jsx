    ...
    return (
      <div>
        ...
        <div className="flex flex-col items-center min-h-screen bg-gray-100 p-4">
          ...
          <div  key={camion.id} className="flex flex-wrap justify-center gap-6 w-full max-w-4xl">
            <Link to="/detallescamion" className="w-full sm:w-1/2 lg:w-1/3 block p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <h2 className="text-xl font-bold mb-2">Matrícula: {camiones.matricula}</h2>
              <p>Marca: {camion.marca}</p>
              <p>Capacidad: {camiones}</p>
              <p>Consumo:{} </p>
              <p>Carga Actual: {}</p>
            </Link>
          }
