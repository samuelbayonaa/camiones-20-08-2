        ...
        <div className="container mx-auto my-8 p-6 bg-white shadow-lg">
          ...
          <div className="flex justify-center mt-6">
            <Link to="/cargarcamion">
              <button type="button" className="py-2 px-6 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500">Cargar camión</button>
            </Link>
          </div>
        </div>
      </div>
